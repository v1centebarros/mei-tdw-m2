...
export function CardSearch() {
    ...
    const {data: results = [], error, isLoading, isError} = useQuery(autoCompleteOptions(query));
        ...
        <div className="relative w-full max-w-md mx-auto">
            ...
            {showResults && (
                ...
                >
                    ...
                    {isError && (
                        <li className="px-4 py-2 text-red-500">Error: {error instanceof Error ? error.message : 'An error occurred'}</li>
                    )}
