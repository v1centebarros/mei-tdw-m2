...
export function ComparisonCard({ card, otherCard }: ComparisonCardProps) {
  const getDifference = (value1: number | string, value2: number | string) => {
  ...
  const renderDifference = (label: string, value1: number | string, value2: number | string) => {
